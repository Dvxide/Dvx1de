...
```bash
$ curl -s https://api.dvx1de.de/info | jq
```
...
```json
{
  ...
  "location": "Germany 🇩🇪",
  "philosophy": "Perseverance meets precision in system administration",
  "learning": [
    "Advanced Networking",
...
Ich bin ein **System Administrator**, der sich auf robuste Infrastruktur, sichere Netzwerke und effiziente Automatisierung spezialisiert hat. Mein Fokus liegt auf der professionellen Verwaltung von Server-Infrastrukturen und der Implementierung sicherer, skalierbarer Lösungen.
